...
function ConsentLayout({ children }: { children: React.ReactNode }) {
  return (
    <main className="flex min-h-dvh flex-col items-center justify-center bg-black px-4">
      <div className="w-full max-w-sm rounded-md border border-zinc-800 bg-zinc-900 p-8 shadow-xl">
        {children}
      </div>
    </main>
  );
